                ...
                @foreach($tchpayments as $tchpayment)
                    <tr>
                        ...
                        <th>
                            ...
                            <a href="{{route('admin.teacher.payment.edit', $tchpayment->id)}}" title="edit" class="btn btn-sm btn-warning" title="edit"><i class='bx bxs-edit-alt'></i></a>
