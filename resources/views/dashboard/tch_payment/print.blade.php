...
<div style="background: #ffeb3b40;" class="container">
    ...
    <table class="rec1">
        ...
        <tr>
            <td  colspan="2"><p class="recipt">Receipt No.#tch{{$data->id}}</p></td>
        </tr>
        <tr>
            <td class="dotborder"><span class="dobremove">Name:</span> <span>{{$data->teacher->name}}</span></td>
            {{--<td class="dotborder"><span class="dobremove">Batch</span>  <span>{{$data->student->batch->name}}</span></td>--}}
        </tr>
        <tr>
            <td class="dotborder"><span class="dobremove">Phone: </span> <span>{{$data->teacher->contact_number}}</span></td>
    ...
    <table id="databox" border="2"  border-collapse="collapse">
        ...
        <tr>
            ...
            <td class="t-center">{{$data->teacher->monthly_salary}}</td>
        </tr>
        <tr>
    ...
    {{--<div id="ui-view" data-select2-id="ui-view">--}}
        {{--<div class="card">--}}
            {{--<div class="card-header"><img class="logo" src="{{asset('images/setting/logo/'.setting('logo'))}}">--}}
                {{--Payment slip <strong>#tch{{$data->id}}</strong>--}}
                ...
                {{--<div class="row mb-4">--}}
                    ...
                    {{--<div class="col-md-4">--}}
                        {{--<div class="row">--}}
                            ...
                            {{--</div>--}}
                            {{--<div class="col-md-6 mt-4">--}}
                                {{--<div>{{$data->teacher->name}}</div>--}}
                                {{--<div>{{$data->teacher->email}}</div>--}}
                                {{--<div>{{$data->teacher->contact_number}}</div>--}}
                            {{--</div>--}}
                        {{--</div>--}}
                    {{--</div>--}}
                {{--</div>--}}
