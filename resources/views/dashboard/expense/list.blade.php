    ...
    <script>
        ...
        $('.data-table').DataTable({
            ...
            columns: [
                ...
                {data: 'expense_purpose', name: 'expense_purpose',orderable: true, searchable: true},
        ...
        {
            var url = '{{ route("admin.expense.destroy",":id") }}';
            $.ajax({
                type: "DELETE",
