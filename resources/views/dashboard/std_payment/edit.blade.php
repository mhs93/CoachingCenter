                ...
                <form action="{{route('admin.student.payment.update',$stdpayment->id)}}" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 form-group" >
                            ...
                            <input type="number" id="monthly_amount" class="m_fee form-control " value="{{ $stdpayment->student->monthly_fee }}" readonly>
                        </div>
                        <div class="col-md-3 form-group">
                            <label for="additional_amount">Extra Amount</label>
                            <input name="additional_amount" oninput="extraAmount()" id="extra_amount" type="number" value="{{$stdpayment->additional_amount}}" class="e_amount form-control @error('additional_amount') is-invalid @enderror">
                        ...
                        <div class="col-md-3 form-group">
                            ...
                            <input name="discount_amount" oninput="discountAmount()" id="discount_amount" type="number" value="{{$stdpayment->discount_amount}}" class="form-control @error('discount_amount') is-invalid @enderror">
                    ...
                    <div class="row mt-2">
                        ...
                        <div class="col-md-4 form-group">
                            ...
                            <input type="text" id="total_amount" class="t_amount form-control @error('total_amount') is-invalid @enderror" name="total_amount" value="{{ $stdpayment->total_amount}}">
                            @error('total_amount')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="note" class="form-control" id="note" cols="40" rows="6">{{$stdpayment->note}}</textarea>
                        @error('note')
